...
class ModelBaseClass(nn.Module):
    def __init__(self, base_model_name: str, no_classes: int, model_type: ModelType = ModelType.NONE):
        ...
        if model_type == ModelType.AUTO_MODEL or model_type == ModelType.SPANBERT_MODEL:
...
class EmotionClassification(ModelBaseClass):
    def __init__(self, base_model_name: str, no_classes: int):
        """
        ...
        super(EmotionClassification, self).__init__(base_model_name, no_classes, ModelType.ROBERTA_SEQUENCE_MODEL)
